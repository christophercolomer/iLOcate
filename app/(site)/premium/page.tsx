...
const plans = [
  {
    ...
    features: [
      ...
      { text: "Offline access to saved places", included: false },
      { text: "Priority event notifications", included: false },
      { text: "Exclusive premium guides", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Offline access to saved places", included: true },
      { text: "Priority event notifications", included: true },
      { text: "Exclusive premium guides", included: true },
